        ...
        with open(tmp_file, "r") as tmp_file_read:
                for j in range(tmp_file_lines_cnt):
                        ...
                        #for table_column_name in range(len(splt_data1)):
                                ...
                                if process_addrs == "NO_JAVA_PROCESS_RUNNING" or process_addrs == "NO_DATA_FOUND":
                                ...
                                if process_addrs == "NO_MYSQL_PROCESS_RUNNING" or process_addrs == "NO_DATA_FOUND":
                                ...
                                if process_addrs == "NO_O3_COMPONENTS_RUNNING" or process_addrs == "NO_DATA_FOUND":
