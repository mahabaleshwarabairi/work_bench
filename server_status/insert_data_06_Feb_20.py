...
def insert_main_gui_data(gui_cat_list, server_data):
        ...
        main_data_insert_query = "INSERT INTO gui_main_data (server_ip, amber_color, server_type, application, circle, monitor_time) VALUES (%s, %s, \'%s\')" %(gui_cat_list, server_data, date_default_time)
